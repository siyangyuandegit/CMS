...
class Bookborrow(models.Model):
    bid = models.ForeignKey('Bookinfo', models.DO_NOTHING, db_column='bid', primary_key=True)
...
class Choosecur(models.Model):
    sid = models.ForeignKey('Stuinfo', models.DO_NOTHING, db_column='sid', primary_key=True)
...
class Techcourse(models.Model):
    tid = models.ForeignKey(Teacherinfo, models.DO_NOTHING, db_column='tid', primary_key=True)
    curid = models.ForeignKey(Course, models.DO_NOTHING, db_column='curid')

    class Meta:
        managed = False
        db_table = 'techcourse'
        unique_together = (('tid', 'curid'),)
